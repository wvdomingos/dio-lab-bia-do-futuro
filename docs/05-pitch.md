# Pitch: Elo - O Assistente Financeiro Híbrido
...
### 2. A Solução (1 min)
> **Cenário:** Mostra o diagrama da arquitetura ou a tela inicial do Elo.

"A resposta é o **Elo**.
O Elo é um Assistente Virtual de Relacionamento Financeiro construído com uma **Arquitetura Híbrida**.
...
Aqui temos o perfil do cliente carregado. O Elo sabe que sou moderado e tenho metas claras.
...
Aqui está o diferencial. O Elo detectou a intenção de cálculo, usou o Python para processar os juros compostos e a IA apenas gerou a explicação do resultado final: R$ 1.130,00. Zero alucinação.
...
"O grande diferencial do Elo é essa **Segurança Cognitiva**.
